...
export default function Step6({
  ...
  const handleSubmit = async () => {
    ...
    if (
      ...
      try {
        ...
        const errorMessage = error?.payload?.error?.message || 
                           error?.message || 
                           t("messages.errors.unknownError");
    ...
    // Final validation: Ensure we have a valid signature ID before proceeding
    if (!finalSignatureId) {
      setShowError(t("newCase.step6.alerts.missingSignature"));
      setIsSubmitting(false);
      return;
    }
...
أنا الموقع أدناه ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ هوية رقم ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ من ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ 
قد وكلت عني المحامي ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ و/ أو المحامي ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
بخصوص ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ

بموجب هذه الوكالة يحق للمحامي الوكيل القيام والتصرف باسمي ونيابة عني بالتصرفات
الآتية منفردة أو مجتمعة، والمتعلقة والناشئة عن الموضوع المذكور أعلاه:

1) مراجعة كافة الجهات المختصة ذات الصلة بالموضوع ومباشرة كافة الإجراءات القانونية المتعقلة بالموضوع المذكور أعلاه.
2) تقديم كافة الطلبات المتعقلة بالموضوع المذكور باسمي وبالنيابة عني والتوقيع عليها، بما فيها طلبات الزيارة والحصول على أي مستندات.
...
اليوم ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ الشهر ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ السنة ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
التوقيع ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ                               المحامي ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ 
